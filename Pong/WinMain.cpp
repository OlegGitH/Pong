#include "Utils.cpp"
/*  Windows-specific header file for the C and C++ programming languages which
...
// main process in every game doing game loop that app is running
...
LRESULT CALLBACK windows_Callback(_In_ HWND hwnd, _In_ UINT uMsg, _In_ WPARAM wParam, LPARAM lParam) {
	LRESULT result = 0;
	switch (uMsg) {
	case WM_CLOSE:
	case WM_DESTROY: {
...
input.buttons[b].is_down = is_down;\
		...
		simulate_screen(&input,delta_time);
